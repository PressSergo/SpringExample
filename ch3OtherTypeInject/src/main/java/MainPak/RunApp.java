...
import InstrumetnLirick.Singer;
...
//        GenericXmlApplicationContext genericXmlApplicationContext = new GenericXmlApplicationContext();
//        genericXmlApplicationContext.load(new ClassPathResource("/configs.xml"));
//        genericXmlApplicationContext.refresh();
//        MessageRender messageRender = genericXmlApplicationContext.getBean("SpecificRender",MessageRender.class);
//        messageRender.render();

        GenericXmlApplicationContext genericXmlApplicationContext = new GenericXmlApplicationContext();
        genericXmlApplicationContext.load(new ClassPathResource("/forSinger.xml"));
        genericXmlApplicationContext.refresh();
